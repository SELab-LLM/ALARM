...
#    args.output_dir = os.path.join(args.output_dir, exp_name)
    ...
    model_output = os.path.join('/'.join(args.output_dir.split('/')[:-1]), "final_model")
...
def get_train_args():
    ...
    parser.add_argument("--code_bert", default='../../trace/codebert',
...
def init_train_env(args, tbert_type):
    ...
    elif tbert_type == 'RAPT' or tbert_type == "I2":
